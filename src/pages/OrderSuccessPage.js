    ...
    return (
        <>
            ...
            <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
                ...
                <p className="mt-6 text-base leading-7 text-gray-600">You can check your orders in <span className="mt-6 text-base font-bold leading-7 text-gray-600">My Account -{'>'} My Orders</span></p>
